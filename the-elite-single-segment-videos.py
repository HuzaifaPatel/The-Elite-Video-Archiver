...
# 	host = "127.0.0.1",
# 	user = "root",
# 	passwd = "theelitehuzi007",
# 	database = "the-elite-videos",
# 	)

import sshtunnel

# https://blog.imdst.com/python-shi-yong-sshsui-dao-lian-jie-mysql/
...
# I changed "bind-address" from "127.0.0.1" to "138.197.162.125" in the mysqld.cnf file found in /etc/mysql/mysql.conf.d
# change it back if i don't need this setup anymore as it may cause security vulnerabilities
